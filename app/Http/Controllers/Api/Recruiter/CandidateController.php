  ...
  public function candidateInfo(Request $request, $id)
  {
    ...
    if (isset($user)) {
      ...
      if (isset($r_profile)) {
        ...
        if (isset($s_profile)) {
          $skill = Skill::where('user_id', $s_profile->user_id)->first()->name;
          $language = Language::where('user_id', $s_profile->user_id)->first()->locale;
          ...
          $s_profile["skill"] = $skill;
          $s_profile["language"] = $language;
